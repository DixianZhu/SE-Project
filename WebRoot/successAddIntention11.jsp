	...
	<body>
			...
			<tr>
				<td align="center" valign="center">
					...
					<table border='0'>
						<tr>
							<td>想去的景点</td>
							<td><s:property value="intendPlace" />
							</td>
						</tr>
						<tr>
							<td>期望的时间</td>
							<td><s:property value="intendTime" />
							</td>
						</tr>
						<tr>
							<td>期望的花费</td>
							<td><s:property value="intendPrice" />
							</td>
						</tr>
						<tr>
							<td>期望同伴的年龄</td>
							<td><s:property value="intendFriendAge" />
							</td>
						</tr>
						<tr>
							<td>期望同伴的性别</td>
							<td><s:property value="intendFriendGender" />
							</td>
						</tr>
						<tr>
							<td>期望同伴的工作</td>
							<td><s:property value="intendFriendOccupation" />
							</td>
						</tr>
						<tr>
							<td>期望同伴的地域</td>
							<td><s:property value="intendFriendLocation" />
							</td>
						</tr>
						<tr>
							<td>期望同伴的爱好</td>
							<td><s:property value="intendFriendHobby" />
							</td>
						</tr>
						<tr>
							<td>组队情况（队长：）</td>
							<td><s:property value="teamName" />
							</td>
						</tr>
					</table>
		...
		<s:submit />
					...
					<s:iterator value="applySet" status="itStatus" id="n">
						<li><s:property value="#itStatus.count" />: 申请用户:
							<s:property value="#n[0]" />&nbsp;&nbsp; 期望出发时间:
							<s:property value="#n[1]" />&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
