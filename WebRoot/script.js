...
window.onload=function ()
{
	...
	var oInputName1=document.getElementById('name1');
	var oInputName2=document.getElementById('name2');
	var oInputName3=document.getElementById('name3');
	var oInputName4=document.getElementById('name4');
	...
	setDefaultText(oInputName, '想去哪？', '#777777', 'black');
	setDefaultText(oInputName1, '期望的时间', '#777777', 'black');
	setDefaultText(oInputName2, '期望花销（RMB）', '#777777', 'black');
	setDefaultText(oInputName3, '期望同伴年龄', '#777777', 'black');
	setDefaultText(oInputContact, '期望同伴性别', '#777777', 'black');
	setDefaultText(oInputComeFrom, '期望同伴地域', '#777777', 'black');
	setDefaultText(oInputName4, '期望同伴爱好', '#777777', 'black');
	setDropDown
	(
	 	oUlDropDown,
		function (sText)
